...
//			bookHeight: 480,
			...
			zoomHint: "Kliknij dwa razy aby powiêkszyæ",
			...
			backgroundImage: "/grafika/flipping/bookBackground_krnmedia.jpg",
...
FlippingBook.prototype.create = function(){
	...
	swfobject.embedSWF("/grafika/flipping/FlippingBook.swf", this.containerId, this.stageWidth, this.stageHeight, "8.0.0", "js/expressInstall.swf", this.settings, {allowScriptAccess: "always", bgcolor:  "#" + this.settings.backgroundColor.toString( 16 ) });
}
...
FlippingBook.prototype.handleWheel = function ( delta ){
	if(typeof(this.getFlippingBookReference().onWheelScroll) == 'function')
