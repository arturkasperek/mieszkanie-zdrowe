...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-includes/js/dist/vendor/wp-polyfill.min.js\n- Error message: "+ e.message);}

try{
( 'fetch' in window ) || document.write( '<script src="https://rednetdom.pl/wp-includes/js/dist/vendor/wp-polyfill-fetch.min.js?ver=3.0.0"></scr' + 'ipt>' );( document.contains ) || document.write( '<script src="https://rednetdom.pl/wp-includes/js/dist/vendor/wp-polyfill-node-contains.min.js?ver=3.42.0"></scr' + 'ipt>' );( window.DOMRect ) || document.write( '<script src="https://rednetdom.pl/wp-includes/js/dist/vendor/wp-polyfill-dom-rect.min.js?ver=3.42.0"></scr' + 'ipt>' );( window.URL && window.URL.prototype && window.URLSearchParams ) || document.write( '<script src="https://rednetdom.pl/wp-includes/js/dist/vendor/wp-polyfill-url.min.js?ver=3.6.4"></scr' + 'ipt>' );( window.FormData && window.FormData.prototype.keys ) || document.write( '<script src="https://rednetdom.pl/wp-includes/js/dist/vendor/wp-polyfill-formdata.min.js?ver=3.0.12"></scr' + 'ipt>' );( Element.prototype.matches && Element.prototype.closest ) || document.write( '<script src="https://rednetdom.pl/wp-includes/js/dist/vendor/wp-polyfill-element-closest.min.js?ver=2.0.2"></scr' + 'ipt>' );( 'objectFit' in document.documentElement.style ) || document.write( '<script src="https://rednetdom.pl/wp-includes/js/dist/vendor/wp-polyfill-object-fit.min.js?ver=2.3.4"></scr' + 'ipt>' );
}
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-includes/js/dist/vendor/wp-polyfill.min.js - AFTER\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-content/plugins/contact-form-7/includes/js/index.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-content/plugins/duracelltomi-google-tag-manager/js/gtm4wp-users.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-content/themes/dns/js/theme.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-includes/js/wp-embed.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-content/plugins/wpforms-lite/assets/js/jquery.validate.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-content/plugins/wpforms-lite/assets/js/mailcheck.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-content/plugins/wpforms-lite/assets/js/punycode.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://rednetdom.pl/wp-content/plugins/wpforms-lite/assets/js/wpforms.js\n- Error message: "+ e.message);}
