  ...
  config: {
      mixins: {
          "Smile_ElasticsuiteCatalog/js/attribute-filter": {
              "RedChamps_ElasticSuiteImprovedNav/js/attribute-filter-mixin": true
          }
      }
  }
};
...
var config = {
    map: {
        '*': {
            ...
            proceedToCheckout:      'Magento_Checkout/js/proceed-to-checkout',
            catalogAddToCart:       'Magento_Catalog/js/catalog-add-to-cart',
            priceSwitcher:          'Magento_Checkout/js/price-switcher',
            priceSwitcherCart:      'Magento_Checkout/js/price-switcher-cart'
        }
    }
};
